...
## Skenario 12: Schedule Blast Once
...
5. Isi recipients manual `qa1@example.com, qa2@example.com`
6. Aktifkan `Include QR Code`
7. Klik `Schedule Blast`

Expected:
- Schedule berhasil walau subject/message dikosongkan
- Operasi baru muncul di tabel `Scheduled Operations`
- Status awal `Pending`
