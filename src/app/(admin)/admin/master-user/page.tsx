        ...
        <form onSubmit={onSearch}>
          <div className={styles.filterToolbar}>
            <div className={`${styles.filterGroup} ${styles.filterGroupMd}`}>
              ...
              <Dropdown id="mu-role-dropdown" className={styles.filterControl} fullWidth options={[{ value: "all", label: "Semua Role" }, { value: "SuperAdmin", label: "Super Admin" }, { value: "AdminEvent", label: "Admin Event" }, { value: "ITLead", label: "IT Lead" }, { value: "DepartmentHead", label: "Dept Head" }]} value={roleFilter} onChange={setRoleFilter} aria-labelledby="mu-role-label" />
            </div>
            <div className={`${styles.filterGroup} ${styles.filterGroupLg}`}>
              <label id="mu-dept-label" className={styles.filterLabel} htmlFor="mu-dept-dropdown">Department</label>
              <Dropdown id="mu-dept-dropdown" className={styles.filterControl} fullWidth options={[{ value: "all", label: "Semua Department" }, ...filterDepartments.map((d) => ({ value: d.DepartmentId, label: d.Name }))]} value={departmentFilter} onChange={setDepartmentFilter} aria-labelledby="mu-dept-label" />
            </div>
            <div className={`${styles.filterGroup} ${styles.filterGroupMd}`}>
              <label id="mu-status-label" className={styles.filterLabel} htmlFor="mu-status-dropdown">Status</label>
              <Dropdown id="mu-status-dropdown" className={styles.filterControl} fullWidth options={[{ value: "all", label: "Semua Status" }, { value: "active", label: "Active" }, { value: "inactive", label: "Inactive" }]} value={statusFilter} onChange={setStatusFilter} aria-labelledby="mu-status-label" />
            </div>
