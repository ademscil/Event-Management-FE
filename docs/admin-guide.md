# Admin Guide — CSI Portal

Panduan penggunaan untuk administrator CSI Portal.
...
1. Buka browser dan akses `http://<server>:3001/admin/login`
...
| Role | Akses |
|---|---|
| **SuperAdmin** | Dashboard, Master User, Audit Trail |
| **AdminEvent** | Dashboard, Event Management, Report, Approval Admin, Best Comments, semua Master Data, Mapping |
...
## 4. Operations (Blast & Reminder)

### Schedule Blast Email

1. Buka event → tab **Operations**
2. Klik **Schedule Blast**
3. Isi form:
   - **Tanggal Jadwal**
   - **Template Email**
...
Sama seperti blast, gunakan tab **Schedule Reminder**.
...
- Untuk pertanyaan teknis, hubungi tim IT atau lihat `docs/technical-document.md`.
