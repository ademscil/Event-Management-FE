...
1. FE: `D:\AOP\csi-dev-FE`
2. BE: `D:\AOP\csi-dev-BE`
3. Mockup utama: `D:\AOP\mockup-admin-csi\admin`
4. Planning tracker: `D:\AOP\mockup-admin-csi\Estimation - CSI Web App For Edit.xlsx`
...
## 3. Setup Backend (`D:\AOP\csi-dev-BE`)

### 3.1 Install dependency

```cmd
cd /d D:\AOP\csi-dev-BE
npm.cmd install
```
...
## 4. Setup Frontend (`D:\AOP\csi-dev-FE`)

### 4.1 Install dependency

```cmd
cd /d D:\AOP\csi-dev-FE
npm.cmd install
```
...
4. Responden isi survey.
5. Approval oleh SuperAdmin/AdminEvent/ITLead sesuai flow.
6. Best comments dipilih.
7. Report dihitung (termasuk before/after takeout).
...
2. BE README: `D:\AOP\csi-dev-BE\README.md`
3. BE deployment notes: `D:\AOP\csi-dev-BE\DEPLOYMENT.md`
4. Progress tracker FE: [./progress-tracker.md](./progress-tracker.md)
5. Progress board FE: [./progress-board.json](./progress-board.json)
