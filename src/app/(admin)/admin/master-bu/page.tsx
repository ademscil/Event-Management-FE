...
export default function MasterBUPage() {
  ...
  const onDownloadTemplate = () => {
    setUploadInfo("Template upload Master BU belum tersedia.");
  };
  ...
  const onUploadMaster = () => {
    ...
    setUploadInfo("Upload bulk Master BU belum tersedia.");
  };
    ...
    <>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.uploadNote}>
          Format file: Excel (.xlsx/.xls). Kolom minimal: BU Code, BU Name, Status.
        </div>
